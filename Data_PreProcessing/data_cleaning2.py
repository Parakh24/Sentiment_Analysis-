...
def remove_special_character(content):
    ...
    # what you want to find, what you want to replace it with, where you want to do it
    ...
    # * -> matches zero or more characters of the previously defined set
...
def remove_stopwords(content):
    ...
    # content.split() -> splits the strings by spaces and stores it in lists
    # example ["this", "is", "just", "a", "movie"]
    # i.strip().lower() -> removes unnecessary spaces and converts into lowercase letters
